...
from tatrapayplus.models.capacity_info import CapacityInfo
from tatrapayplus.models.order import Order
...
class PayLater(BaseModel):
    ...
    """ # noqa: E501
    order: Order
    capacity_info: Optional[CapacityInfo] = Field(default=None, alias="capacityInfo")
    __properties: ClassVar[List[str]] = ["order", "capacityInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capacityInfo": CapacityInfo.from_dict(obj["capacityInfo"]) if obj.get("capacityInfo") is not None else None
        })
        return _obj
