...
PAYMENTINTENTSTATUSRESPONSESTATUS_ONE_OF_SCHEMAS = ["BankTransferStatus", "CardPayStatusStructure", "PayLaterStatus"]

class PaymentIntentStatusResponseStatus(BaseModel):
    ...
    """
    # data type: CardPayStatusStructure
    oneof_schema_1_validator: Optional[CardPayStatusStructure] = None
    # data type: BankTransferStatus
    oneof_schema_2_validator: Optional[BankTransferStatus] = None
    # data type: PayLaterStatus
    oneof_schema_3_validator: Optional[PayLaterStatus] = None
    actual_instance: Optional[Union[BankTransferStatus, CardPayStatusStructure, PayLaterStatus]] = None
    one_of_schemas: Set[str] = { "BankTransferStatus", "CardPayStatusStructure", "PayLaterStatus" }
