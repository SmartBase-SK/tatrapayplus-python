...
class BasePayment(BaseModel):
    ...
    """ # noqa: E501
    instructed_amount: Amount = Field(alias="instructedAmount")
    end_to_end: E2e = Field(alias="endToEnd")
    __properties: ClassVar[List[str]] = ["instructedAmount", "endToEnd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BasePayment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BasePayment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "instructedAmount": Amount.from_dict(obj["instructedAmount"]) if obj.get("instructedAmount") is not None else None,
